...
//        25,12,12,2,                                                                           // Length,horz,vert,byte/vert
        ...
        25,     // количество байт на 1 символ = (ширина в точках) * (число байт на 1 вертикальный столбец в символе) + 1 (в начале идет ширина символа)
        12,     // ширина в точках (битах)
        12,     // высота в точках (битах)
