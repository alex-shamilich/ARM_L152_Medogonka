...
113,    // количество байт на 1 символ = (ширина в точках) * (число байт на 1 вертикальный столбец в символе) + 1 (в начале идет ширина символа)
28,     // ширина в точках (битах)
28,     // высота в точках (битах)
4,      // число байт на 1 вертикальный столбец в символе (= высота в точках (битах) / 8)
