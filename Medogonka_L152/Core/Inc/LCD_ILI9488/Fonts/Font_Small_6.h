const unsigned char Small_6[] = {
      //  9,8,8,1,                                    // Length,horz,vert,byte/vert
        ...
        127,    // конечный символ в наборе
          9,    // количество байт на 1 символ = (ширина в точках) * (число байт на 1 вертикальный столбец в символе) + 1 (в начале идет ширина символа)
          8,    // ширина в точках (битах)
          8,    // высота в точках (битах)
          1,    // число байт на 1 горизонтальную строку в символе
