...
const unsigned char Small_7[] = {
       ...
       127,    // конечный символ в наборе
        19,    // количество байт на 1 символ = (ширина в точках) * (число байт на 1 вертикальный столбец в символе) + 1 (в начале идет ширина символа)
         9,    // ширина в точках (битах)
         9,    // высота в точках (битах)
         2,    // число байт на 1 горизонтальную строку в символе
